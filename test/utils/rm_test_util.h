...
namespace PeterDBTesting {
    ...
    public:
        ...
        void SetUp() override {
            ...
            //std::cout<<"I ran this function"<<std::endl;
            ...
            if (!fileExists(tableName)) 
            {
                ...
                ASSERT_TRUE(fileExists("Tables")) << "Table " << tableName << " file should exist now.";
                ASSERT_TRUE(fileExists("Columns")) << "Table " << tableName << " file should exist now.";
            }
